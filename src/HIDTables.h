...
// The definitions below have been updated from from the newer USB HID
// Usage Tables 1.2 document (as of 2020-09-11):
// https://www.usb.org/sites/default/files/hut1_2.pdf
//
// Note: It does not appear to be true any longer that only Consumer
// Control keycodes with HID type OSC (One Shot Control) will work. In
// particular, some keycodes with usage type RTC (Re-Trigger Control)
// and OOC (On/Off Control) are also functional.
